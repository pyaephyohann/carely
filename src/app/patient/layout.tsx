...
const navItems = [
  ...
  { href: "/patient/appointments", label: "Appointments", icon: Calendar, disabled: true },
  { href: "/patient/prescriptions", label: "Prescriptions", icon: FileText, disabled: true },
...
export default function PatientLayout({
  ...
  const firstName = (user?.profile as Record<string, string>)?.firstName || "Patient";
            ...
            <AnimatePresence>
              {!collapsed && (
                ...
                >
                  ...
                  <p className="text-xs text-muted-foreground capitalize">Patient</p>
                </motion.div>
              )}
            </AnimatePresence>
            <button
