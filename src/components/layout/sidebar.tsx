...
export function Sidebar({ role, firstName = "User", lastName = "" }: SidebarProps) {
  ...
  return (
    <motion.aside
      ...
      className="h-screen bg-white border-r border-zinc-200 flex flex-col sticky top-0"
    >
      {/* Logo */}
          ...
          <AnimatePresence>
            {!collapsed && (
              <motion.span
                ...
                className="text-lg font-bold text-zinc-900 whitespace-nowrap"
              >
                Carely
              </motion.span>
            )}
      ...
      <div className="px-3 py-4 border-t border-zinc-100">
        <div className="flex items-center gap-3">
          ...
          <button
            ...
            className="p-1.5 rounded-lg text-zinc-400 hover:bg-zinc-100 hover:text-zinc-600 transition-colors flex-shrink-0"
