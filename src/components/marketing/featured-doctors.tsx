...
// Static demo data — isolated from production data logic.
// These will be replaced by RTK Query data when the doctor API is implemented.
const demoDoctors = [
  {
    id: "demo-1",
    firstName: "Sarah",
              ...
              >
                <div className="flex items-start gap-3 mb-4">
                  ...
                  <div className="min-w-0">
                    <h3 className="font-semibold text-zinc-900 group-hover:text-violet-600 transition-colors truncate">
